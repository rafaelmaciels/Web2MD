/**
 * Filename sanitizer utility for Web2MD
 * Ensures filenames are compliant with Windows, macOS, and Linux filesystem constraints.
 */
...
export function sanitizeFilename(title: string, fallback = 'web2md_export'): string {
  ...
  // 1. Remove invalid Windows & Unix filename characters
  let clean = title
  ...
  // 3. Check for reserved Windows filenames (CON, PRN, AUX, NUL, COM1..9, LPT1..9)
